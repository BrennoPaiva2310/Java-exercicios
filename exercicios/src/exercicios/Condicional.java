...
public class Condicional {
	...
	public static void main(String[] args) {
		...
		if (diaSemana.equalsIgnoreCase("Domingo") == true) {
		...
		} else if (diaSemana.equalsIgnoreCase("Terça") == true || diaSemana.equalsIgnoreCase("Terça") == true ) {
			...
			System.out.println("6");
		} else if (diaSemana.equalsIgnoreCase("Sabado") == true || diaSemana.equalsIgnoreCase("Sábado") == true) {
